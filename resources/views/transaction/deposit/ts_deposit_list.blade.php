...
@section('content')
    <div class="row">
        <div class="col-md-2 col-sm-6 col-lg-2">
            <a href="{{ url('get-deposits/simpanan-pokok') }}" style="color: #000;">
        ...
        <div class="col-md-2 col-sm-6 col-lg-2">
            <a href="{{ url('get-deposits/simpanan-wajib') }}" style="color: #000;">
                <div class="info-box" style="padding: 10px">
                    <!-- Apply any bg-* class to to the icon to color it -->
        ...
        <div class="col-md-2 col-sm-6 col-lg-2">
            <a href="{{ url('get-deposits/simpanan-sukarela') }}" style="color: #000;">
                <div class="info-box" style="padding: 10px">
                    <!-- Apply any bg-* class to to the icon to color it -->
        ...
        <div class="col-md-2 col-sm-6 col-lg-2">
            <a href="{{ url('get-deposits/simpanan-shu') }}" style="color: #000;">
                <div class="info-box" style="padding: 10px">
                    <!-- Apply any bg-* class to to the icon to color it -->
        ...
        <div class="col-md-2 col-sm-6 col-lg-2">
            <a href="{{ url('get-deposits/simpanan-lainnya') }}" style="color: #000;">
                <div class="info-box" style="padding: 10px">
                    <!-- Apply any bg-* class to to the icon to color it -->
...
@section('appjs')
    <script>
    initDatatable('#listTsDeposits', 'ts-deposits');
    // show data record
